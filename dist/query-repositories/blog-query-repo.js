...
exports.blogQueryRepo = {
    getBlog(searchNameTerm, sortBy, sortDirection, pageNumber = 1, pageSize = 10) {
        return __awaiter(this, void 0, void 0, function* () {
            const blogsPagination = (pageNumber - 1) * pageSize;
            const totalCount = yield db_1.blogsCollection.countDocuments({});
            const pagesCount = Math.ceil(totalCount / pageSize);
            const getBlog = yield db_1.blogsCollection.find({ name: { $regex: searchNameTerm } }).skip(blogsPagination).toArray();
