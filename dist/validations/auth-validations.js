...
exports.authValidations = exports.confirmationCodeValidation = exports.passwordValidation = exports.loginOrEmailValidation = void 0;
...
exports.confirmationCodeValidation = (0, express_validator_1.body)("code").isString().trim().notEmpty();
