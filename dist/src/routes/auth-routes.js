...
exports.authRoutes.get('/me', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const token = req.headers.
    ;
    const getCurrentUserInfo = yield jwt_service_1.jwtService.getUserIdByToken(token);
}));
